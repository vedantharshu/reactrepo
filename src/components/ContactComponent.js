...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum , email){
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            errors.firstname=" length not less than 3";
        else if(this.state.touched.firstname && firstname.length > 13)
            errors.firstname=" length not more than 13";
        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname=" length not less than 3";
        else if(this.state.touched.lastname && lastname.length > 13)
            errors.lastname=" length not more than 13";
        const reg= /^\d+$/;
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum=" no alphabets allowed";
